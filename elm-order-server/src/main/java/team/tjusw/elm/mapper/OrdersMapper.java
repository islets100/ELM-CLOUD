...
public interface OrdersMapper {
	...
	@Select("select * from orders where businessId=#{businessId} order by orderId desc")
	...
	public Integer updateOrderState(@Param("orderId") Integer orderId, @Param("orderState") Integer orderState);
}
